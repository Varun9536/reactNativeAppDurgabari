...
// export default function ViewMoreDetailFood({ title, subtitle, description, onBack, img }) {
...
export default function ViewMoreDetailFood({
    title,
    subtitles = [],
    times = [],
    description,
    ...
    useEffect(() => {
        setValidImage(true); // reset on image change
    }, [img]);
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: "#fff" }}>
            ...
            <View style={styles.content}>
                ...
                {/* All subtitles with time (if available) */}
                {subtitles.length > 0 && (
